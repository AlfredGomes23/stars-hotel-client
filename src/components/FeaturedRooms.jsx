    ...
    return (
        <div className="lg:w-2/3 mx-auto mb-5">
            ...
            <div className="carousel w-full" data-aos="flip-right">
                <div id="slideF1" className="carousel-item relative w-full rounded-lg overflow-hidden ">
                ...
                <div id="slideF2" className="carousel-item relative w-full rounded-lg overflow-hidden">
                ...
                <div id="slideF3" className="carousel-item relative w-full rounded-lg overflow-hidden">
                ...
                <div id="slideF4" className="carousel-item relative w-full rounded-lg overflow-hidden">
